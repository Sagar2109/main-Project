...
<html>
<head>
<title>My JSP 'dis.jsp' starting page</title>
	...
	<table border="1" width="1000px">
		...
		<tr>
			...
			<c:forEach items="${result}" var="str">
				...
				<tr>
					<td>${str.id}</td>
					<td>${str.customername}</td>
					<td colspan="1">${str.mobileno}</td>
					<td>${str.email}</td>
					<td>${str.movienm}</td>
					<td>${str.time}</td>
					<td>${str.price}</td>
					<td>${str.totalticktes}</td>
					<td>${str.totalprize}</td>
					<td><a href="/editandshow/${str.id}">Edit</a></td>
					<td><a href="/delete/${str.id}">Delete</a></td>
				</tr>
			</c:forEach>
    ...
    <div class="container">
        ...
        <div class="w3ls-reg">
            ...
            <div class="displayerBoxes txt-center" style="overflow-x:auto;">
                ...
                <form action="/give">
                <input type="text" name="var4" value="saga">
                <input type="submit">
